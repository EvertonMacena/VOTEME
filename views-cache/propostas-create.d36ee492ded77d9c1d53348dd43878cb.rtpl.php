...
<section class="content-header">
  <h1>
    Cadastro de proposta para <?php echo htmlspecialchars( $candidato["nome"], ENT_COMPAT, 'UTF-8', FALSE ); ?>
  </h1>
  <ol class="breadcrumb">
  ...
  <div class="row">
  	<div class="col-md-12">
        ...
        <div class="box-header with-border">
          <h3 class="box-title">Nova Proposta</h3>
        </div>
        <!-- /.box-header -->
        <!-- form start -->
        <form role="form" action="/admin/candidatos/<?php echo htmlspecialchars( $candidato["id"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/propostas/create" method="post">
          <div class="box-body">
